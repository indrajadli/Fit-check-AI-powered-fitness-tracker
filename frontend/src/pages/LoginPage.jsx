      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-slate-900 items-center justify-center">
        ...
        <div className="relative z-10 p-12 max-w-xl">
          ...
          <h1 className="text-6xl font-bold text-white leading-tight mb-6">
            Elevate Your <br />
            <span className="text-primary-400">Fitness Journey</span>
          </h1>
          <p className="text-xl text-slate-200 leading-relaxed">
            Track your progress, get AI-powered coaching, and achieve your peak physical condition with our intelligent platform.
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="relative py-4">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white text-slate-500 font-medium">New to FitCheck?</span>
              </div>
            </div>
